...
// Get the user login status. Determines which navbar button to display on page load
...
function statusChangeCallback(response) {
    ...
    var facebookButton = document.getElementById("fb-button");
