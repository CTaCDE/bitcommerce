...
function loadChart(objects) {
    ...
    objects.forEach(function(d){
        ...
        console.log(d.date.getDate().toString()+d.date.getMonth().toString()+d.date.getFullYear().toString());
        if(aggtimes[d.date.getDate().toString()+d.date.getMonth().toString()+d.date.getFullYear().toString()]) {
            aggtimes[d.date.getDate().toString()+d.date.getMonth().toString()+d.date.getFullYear().toString()] = aggtimes[d.date.getDate().toString()+d.date.getMonth().toString()+d.date.getFullYear().toString()] + d.value;
        } else {
            aggtimes[d.date.getDate().toString()+d.date.getMonth().toString()+d.date.getFullYear().toString()] = d.value;
        }
    });
    
    for(var j = 0; j < objects.length; j++) {
        objects[j].value = aggtimes[objects[j].date.getDate().toString() + objects[j].date.getMonth().toString() + objects[j].date.getFullYear().toString()];
